function getQuote() 
{
    ...
    quotes[4] = "Simplicity is the ultimate sophistication.";
    sources[4] = "Leonardo DaVinci";
    ...
    qtString = "<p style='background-color: #ffb6c1' >\"" 
                + quotes[i] + "\"" + "<em>- " + sources[i] + "</em>"
                + "</p>";
    qt.innerHTML = qtString;
}